...
namespace Projeto_Educa_Sonho_Meu.Arquivos.Classes
{
    public class Funcionario
    {
        ...
        public Funcionario(int id_func, string nome_func, string cpf_func, string ctps_func, string rg_func, string funcao_func, int id_sal_fk, string num_telefone_func, int id_end_fk)
        {
